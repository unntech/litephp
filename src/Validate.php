...
class Validate{
    ...
    public static function isInteger($val, $bigInt = false): bool {
        ...
        return preg_match(LiRegular::$patternInteger, strval($val));
    }
    ...
    public static function isNaturalNum($val): bool {
        return is_numeric($val) && preg_match(LiRegular::$patternNaturalNum, strval($val));
    }
    ...
    public static function isBinary(string $val): bool {
        return !empty($val) && preg_match(LiRegular::$patternBinary, $val);
    }
    ...
    public static function isEmail(string $val, int $minLen = 6, int $maxLen = 40): bool {
        $len = strlen($val);
        return $minLen <= $len && $len <= $maxLen && filter_var($val, FILTER_VALIDATE_EMAIL) && preg_match(LiRegular::$patternEmail, $val);
    }
    ...
    public static function isMobilecn(string $val): bool {
        return !empty($val) && preg_match(LiRegular::$patternMobilecn, $val);
    }
    ...
    public static function isTel(string $val): bool {
        return !empty($val) && (preg_match(LiRegular::$patternTel, $val) || preg_match(LiRegular::$patternTel4800, $val));
    }
    ...
    public static function isUrl(string $val): bool {
        return !empty($val) && filter_var($val, FILTER_VALIDATE_URL) && preg_match(LiRegular::$patternUrl, $val);
    }
    ...
    public static function isChinaCreditNo(string $val): bool {
        ...
        //18位或15位
        if (empty($val) || !preg_match(LiRegular::$patternCnIdNo, $val)) {
            return false;
        }
    ...
    public static function isChinese(string $val): bool {
        return !empty($val) && @preg_match(LiRegular::$patternAllChinese, $val);
    }
    ...
    public static function hasChinese(string $val): bool {
        return !empty($val) && @preg_match(LiRegular::$patternHasChinese, $val);
    }
    ...
    public static function isAlpha(string $val): bool {
        return !empty($val) && @preg_match(LiRegular::$patternAlpha, $val);
    }
    ...
    public static function isAlphaNum(string $val): bool {
        return $val !== '' && @preg_match(LiRegular::$patternAlphaNum, $val);
    }
    ...
    public static function isAlphaNumDash(string $val): bool {
        return $val !== '' && @preg_match(LiRegular::$patternAlphaNumDash, $val);
    }
    ...
    public static function isAlphaChinese(string $val): bool {
        return !empty($val) && @preg_match(LiRegular::$patternAlphaChinese, $val);
    }
    ...
    public static function isAlphaNumChinese(string $val): bool {
        return $val !== '' && @preg_match(LiRegular::$patternAlphaNumChinese, $val);
    }
    ...
    public static function isAlphaNumDashChinese(string $val): bool {
        return $val !== '' && @preg_match(LiRegular::$patternAlphaNumDashChinese, $val);
    }
    ...
    public static function hasLetter(string $val): bool {
        return !empty($val) && @preg_match(LiRegular::$patternHasLetter, $val);
    }
    ...
    public static function isSpace(string $str): bool {
        return $str != '' && preg_match(LiRegular::$patternSpace, $str);
    }
    ...
    public static function isWhitespace(string $str): bool {
        return $str != '' && preg_match(LiRegular::$patternWhitespace, $str);
    }
    ...
    public static function isMultibyte(string $str): bool {
        return $str != '' && preg_match(LiRegular::$patternMultibyte, $str);
    }
    ...
    public static function isWord(string $val): bool {
        return !empty($val) && preg_match(LiRegular::$patternWord, $val);
    }
    ...
    public static function isDate2time(string $val): int {
        ...
        $val   = str_replace('/', '-', $val);
        $check = preg_match(LiRegular::$patternDatetime, $val);
        if (!$check) {
            return 0;
        }
    ...
    public static function isBase64Image(string $val) {
        ...
        if (!preg_match(LiRegular::$patternBase64Image, $val, $match)) {
            return false;
        }
    ...
    public static function isQQ(string $val): bool {
        return !empty($val) && preg_match(LiRegular::$patternQQNo, $val);
    }
    ...
    public static function isIndexArray($arr): bool {
        ...
        if (is_array($arr) && !empty($arr)) {
            ...
            $res = boolval(preg_match(LiRegular::$patternInteger, $str));
        }
